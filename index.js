	...
	#applyConfig(configAttrib)
	{
		for (var [confElemKey, confElemValue] of Object.entries(configAttrib))
		{
			...
			switch (confElemKey) 
			{
				...
				case 'close':
					if (typeof(confElemValue) !== 'boolean') return console.log(new Error(`Setting ${confElemKey} is expected to be of type 'boolean'. Got type ${typeof(confElemValue)}.`).stack);
					this.#config.packetQueue.push(`ui|close`);
				break;
				...
				case 'width':
					...
					this.#config.packetQueue.push(`ui|width|${confElemValue}`);
				break;

				case 'height':
					if (typeof(confElemValue) !== 'number') return console.log(new Error(`Setting ${confElemKey} is expected to be of type 'number'. Got type ${typeof(confElemValue)}.`).stack);
					this.#config.packetQueue.push(`ui|height|${confElemValue}`);
				break;
				...
				case 'x':
					...
					this.#config.packetQueue.push(`ui|xPos|${confElemValue}`);
				break;

				case 'y':
					if (typeof(confElemValue) !== 'number') return console.log(new Error(`Setting ${confElemKey} is expected to be of type 'number'. Got type ${typeof(confElemValue)}.`).stack);
					this.#config.packetQueue.push(`ui|yPos|${confElemValue}`);
				break;

				case 'backImage':
					if (confElemValue === null) {  this.#config.packetQueue.push(`ui|backImage|`);  break;  }
					if (typeof(confElemValue) !== 'string') return console.log(new Error(`Setting ${confElemKey} is expected to be of type 'string'. Got type ${typeof(confElemValue)}.`).stack);	
					var fullPath = null;
				...
				case 'icon':
					if (confElemValue === null) { this.#config.packetQueue.push(`ui|icon|`); break; }
					if (typeof(confElemValue) !== 'string') return console.log(new Error(`Setting ${confElemKey} is expected to be of type 'string'. Got type ${typeof(confElemValue)}.`).stack);	
					var fullPath = null;
				...
				case 'topMost':
					if (typeof(confElemValue) !== 'boolean') return console.log(new Error(`Setting ${confElemKey} is expected to be of type 'boolean'. Got type ${typeof(confElemValue)}.`).stack);
					this.#config.packetQueue.push(`ui|topMost|${confElemValue}`);
				break;

				case 'notify':
					if (typeof(confElemValue) !== 'string') return console.log(new Error(`Setting ${confElemKey} is expected to be of type 'string'. Got type ${typeof(confElemValue)}.`).stack);
					this.#config.packetQueue.push(`ui|notify|${confElemValue}`);
				break;
			}
